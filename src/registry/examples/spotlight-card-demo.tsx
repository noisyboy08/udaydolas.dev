  ...
  return (
    <div className="flex w-full max-w-xs flex-col gap-3 p-2">
      <SpotlightCard spotlightColor="rgba(139, 92, 246, 0.18)">
        <h3 className="mb-1 text-sm font-semibold text-zinc-900 dark:text-white">Spotlight Card</h3>
      ...
      <SpotlightCard spotlightColor="rgba(6, 182, 212, 0.18)">
        <h3 className="mb-1 text-sm font-semibold text-zinc-900 dark:text-white">Cyan Glow</h3>
        <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
