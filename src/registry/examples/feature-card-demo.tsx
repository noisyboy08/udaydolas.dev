...
export default function FeatureCardDemo() {
  return (
    <div className="grid w-full max-w-2xl grid-cols-1 gap-3 p-2 sm:grid-cols-3">
      <FeatureCard
        title="Zero Dependencies"
        description="Built with vanilla React. No extra packages needed."
      ...
      <FeatureCard
        title="Animated"
        description="GPU-powered micro-interactions out of the box."
