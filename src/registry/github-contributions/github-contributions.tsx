...
export function GithubContributions({
  ...
  const getColor = (level: number) => {
    switch (level) {
      case 0: return "bg-[#ebedf0] dark:bg-[#161b22] border border-[#1b1f23]/6 dark:border-white/5";
  ...
  return (
    <div className={cn("w-full text-zinc-900 dark:text-foreground font-sans selection:bg-emerald-500/30", className)}>
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mb-2 flex items-center justify-between px-1">
            <h3 className="text-sm font-normal text-zinc-850 dark:text-zinc-100">
              <span className="font-semibold">{totalContributions} contributions</span> in the last year
            </h3>
            <button className="text-xs text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200 flex items-center gap-1.5 transition-colors">
              Contribution settings
              <span className="text-[9px] text-zinc-450 dark:text-zinc-500">▼</span>
            </button>
          </div>

          {/* Graph Outer Card */}
          <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0d1117] p-4 shadow-lg overflow-hidden">
            {/* The scrollable graph container */}
            <div className="overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-zinc-350 dark:scrollbar-thumb-zinc-700">
              <div className="min-w-[620px] flex flex-col">
                
                {/* Month labels */}
                <div className="flex pl-7 mb-1 text-[10px] text-zinc-500 dark:text-zinc-400 select-none">
                ...
                <div className="flex gap-2">
                  ...
                  {/* Days labels */}
                  <div className="flex flex-col justify-between py-1.5 text-[9px] text-zinc-500 dark:text-zinc-400 w-5 select-none leading-none h-[78px]">
            ...
            <div className="mt-3 flex flex-wrap items-center justify-between text-[11px] text-zinc-500 dark:text-zinc-400 pt-2 border-t border-zinc-200 dark:border-t-zinc-800/60">
              <a 
                href={`https://github.com/${username}`} 
                target="_blank" 
                rel="noreferrer" 
                className="hover:text-[#0969da] dark:hover:text-emerald-400 transition-colors"
              >
                Learn how we count contributions
              </a>
              <div className="flex items-center gap-1.5 select-none">
                <span>Less</span>
                <span className="size-[9px] rounded-[1px] bg-[#ebedf0] dark:bg-[#161b22] border border-[#1b1f23]/6 dark:border-white/5" />
